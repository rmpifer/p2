...
function redirect(picid){
	...
	history.pushState(stateContent, null, "http://class6.eecs.umich.edu/w8ahkxll/p3/api/v1/pic/"+picid);
}
...
function loadAlbum(albumid){
	...
	$.ajax({
		...
		data: JSON.stringify(),
		url: "http://class6.eecs.umich.edu/w8ahkxll/p3/api/v1/album/"+albumid,
		success: function(data) { 
			...
			for (i = 0; i < pics.length; ++i){
				htmlContent = htmlContent + "<p ><img src=\"/static/images/images/" + pics[i]['picID'] + "." + pics[i]['format'] + "\" onclick=\"redirect('" + pics[i]['picID'] + "')\"></p>";
			...
			$.ajax({
				...
				success: function(data){
					...
					if(sessionUser == username){
						htmlContent = htmlContent + "<a href=\"http://class6.eecs.umich.edu/w8ahkxll/p3/album/edit\" id=\"album_edit_" + albumid + "_link\">Edit</a>";
					}
				},
...
function loadPic(picid){
	...
	$.ajax({
		...
		contentType: "application/json; charset=UTF-8",
		data: JSON.stringify(),
		url: "http://class6.eecs.umich.edu/w8ahkxll/p3/api/v1/pic/"+ picid,
		success: function(data){
			var albumid = data['albumid'];
			...
			htmlContent = "<img src=\"/static/images/images/" + picid + "." + format + "\">";
			...
			htmlContent = htmlContent + "<p onclick=\"redirect('" + next + "')\">Next</p>";
